...
The Deleteble Attachments allows to render the attachments in a read-only mode. This widget is not a replacement of the attachment widget since it does not let you upload, delete or edit existing attachments.
...
Here is an example of using the Deleteble Attachments widget using the 'tiles' displayFormat inside a details tab or using the 'list' displayFormat in the utility column.

![Example of using the Deleteble Attachments in a Case View](DeletebleAttachments_Demo.png)
