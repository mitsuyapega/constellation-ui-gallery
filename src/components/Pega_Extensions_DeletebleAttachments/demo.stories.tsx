...
export default {
  ...
  component: PegaExtensionsDeletebleAttachments,
};
...
type Story = StoryObj<typeof PegaExtensionsDeletebleAttachments>;

const DeletebleAttachmentsDemo = (inputs: UtilityListProps) => {
  return {
    render: (args: UtilityListProps) => {
      ...
      return <PegaExtensionsDeletebleAttachments {...props} />;
    },
    args: inputs,
  };
};
